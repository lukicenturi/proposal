...
- **Value proposition first**: a first-time visitor must understand what the company does and what they get within the first viewport, before any scrolling. State the service category and core benefit in plain words in the banner itself (the headline, or a label directly above it). Poetic or metaphorical headlines are allowed only once the offer is already explicit; a metaphor may never be the only explanation. (Lesson from VISAE XPERT: the hero led with "Paspor penuh stempel, tanpa sekali pun antre", and you had to read the sub-line to learn it was a visa service.)
...
| `one-stop` | One Stop Car Workshop (IG @onestop_carworkshop) | Bengkel mobil umum (tune-up, oli, AC, rem, kaki-kaki, aki, scan engine, storing darurat), 4.9 (80 ulasan) di Google, Ruko Alicante Blok C No. 28, Medang, Pagedangan, Gading Serpong, Kab. Tangerang. Real WA: 0877-5466-2200. Sen-Jum 09.00-19.00, Sab 08.00-19.00, Minggu libur | Demo built |
| `brocoating` | BROCOATING Auto Detailing (IG @brocoating_, English bio) | PPF, nano ceramic coating & detailing, 5.0 (96 ulasan) di Google, buka 24 jam, Jl. BSD Raya Utama No.8, Cihuni, Pagedangan, Kab. Tangerang. Real WA: 0812-9438-3491 (owner Wan). TikTok @brocoating.official, PPF acct @bro.ppf | Demo built |
| `gorillaz` | Gorillaz Scientia Gading Serpong (IG @gorillazscientiags) | EV coating, detailing & treatment (bengkel bodi mobil), 4.8 (50 ulasan) di Google, Scientia area, Medang, Pagedangan, Kab. Tangerang. Real WA: 0813-1510-9630. By appointment, Senin tutup, Sel-Min 09.00-18.00. Bio EN, demo in English | Demo built |
| `manna-law-firm` | Manna Law Firm (IG @manna_lawfirm) | Litigation & corporate lawyer, 4.8 (17 ulasan) di Google, Ruko The Hive Parc Himalaya Lt. 2 No. 32, Jl. Boulevard Palem Raya No. 2000, Lippo Karawaci, Kelapa Dua, Kab. Tangerang. WA (bio + papan nama): 0813-8035-0600, telp Maps: 0896-7344-5936, email mannalawfirm@gmail.com. Sen-Jum 09.00-17.00. Logo: 3 gelombang biru, recreated as assets/logo.svg | Demo built |
| `hygloss.id` | Hygloss Autodetailing (IG @hygloss.id, 2.7K followers, English bio) | PPF, nano coating & ultimate detailing (premium wash), 4,8 (21 ulasan) di Google, Distrik Otomotif PIK 2, Salembaran Jati, Kec. Kosambi, Kab. Tangerang, Banten 15214. Real WA: 0811-1382-229. Buka setiap hari 07.30-17.00 (Sabtu 09.00-17.00). Maps bio link: maps.app.goo.gl/R5hhoPwr5C5WGuDs7. Demo in English | Demo built |
| `dens-autoworks` | Dens Autoworks 507 Power (IG @densautoworks, 30K followers) | Bengkel spesialis diesel: remap ECU 507 Power (tuner @ronnyhao507, 1500+ mobil), modifikasi & perawatan diesel, 4.9 (171 ulasan) di Google, Ruko Sutera Niaga I, Jl. Raya Serpong KM 7 No.31, Pakulonan, Serpong Utara, Tangsel (Alam Sutera). WA remap: 0821-1045-0778, WA booking servis: 0812-121-507. Sen-Sab 09.00-17.00, Minggu libur. Linktree: linktr.ee/densautoworks507power | Demo built |
| `visae-expert` | VISAE XPERT PT. Pramulia Xpert Solutions (IG @visae.xpert, bio EN) | Jasa pengurusan visa, paspor, tiket, pajak & dokumen (expat legal services), 5.0 (30 ulasan) di Google, milik perempuan, sejak 2021, 24/7 by appointment. Ruko Tabe Spot, Jl. BSD Raya Pusat No.2 Blok G7, Lengkong Kulon, Pagedangan, Kab. Tangerang. WA: 0822-4421-8083, kantor (021) 38929204. Linktree: linktr.ee/Visaeexpert. Demo in Bahasa Indonesia (user decision, overriding EN bio) | Demo built |
